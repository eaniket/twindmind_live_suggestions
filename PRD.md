...
- **Settings:** Editable fields for modifying the prompts and other settings:
  - Live suggestion prompt
  - Detailed answers on-click prompt
  - Chat prompt
  - Context window for live suggestions
  - Context window for expanded answers on click, etc.
  - Hardcode the default parameters with the optimal values and prompts that you find
...
- **Interview:** During your interview, you will share your screen, open your deployed app, and we will use it live while we talk
